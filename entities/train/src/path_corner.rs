...
bitflags! {
    ...
    pub(crate) struct SpawnFlags: u32 {
...
impl PathCorner {
    pub(crate) fn spawn_flags(&self) -> SpawnFlags {
...
#[doc(hidden)]
#[macro_export]
macro_rules! export_path_corner {
    () => {
        $crate::export_entity!(path_corner, $crate::path_corner::PathCorner);
    };
}
#[doc(inline)]
pub use export_path_corner as export;
