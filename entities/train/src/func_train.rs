...
use xash3d_server::{
    entity::{
        BaseEntity, DamageFlags, Effects, EntityHandle, KeyValue, MoveType, ObjectCaps, Solid,
...
use crate::path_corner::PathCorner;
...
#[doc(hidden)]
#[macro_export]
macro_rules! export_func_train {
    () => {
        $crate::export_entity!(func_train, $crate::func_train::Train);
    };
}
#[doc(inline)]
pub use export_func_train as export;
