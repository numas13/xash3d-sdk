...
use crate::path_track::PathTrack;
...
#[doc(hidden)]
#[macro_export]
macro_rules! export_func_tracktrain {
    () => {
        $crate::export_entity!(func_tracktrain, $crate::func_tracktrain::TrackTrain);
    };
}
#[doc(inline)]
pub use export_func_tracktrain as export;
