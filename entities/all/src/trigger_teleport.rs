...
use xash3d_server::{
    ...
    entity::{delegate_entity, EdictFlags, BaseEntity, KeyValue},
ffi::common::vec3_t,
    prelude::*,
...
define_export! {
    export_trigger_teleport as export if "trigger-teleport" {
        trigger_teleport = trigger_teleport::TriggerTeleport,
    }
}
