use xash3d_server::{
    entity::{delegate_entity, BaseEntity, Effects, Solid, UseType},
    prelude::*,
    private::impl_private,
};

use crate::func_wall::FuncWall;
...
define_export! {
    export_func_wall_toggle as export if "func-wall-toggle" {
        func_wall_toggle = func_wall_toggle::WallToggle,
    }
}
