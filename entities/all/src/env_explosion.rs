...
use xash3d_server::{
    engine::TraceIgnore,
    entity::{
        create_entity, delegate_entity, BaseEntity, Effects, KeyValue, MoveType, Solid, UseType,
    },
    ffi::common::vec3_t,
    prelude::*,
...
define_export! {
    export_env_explosion as export if "env-explosion" {
        env_explosion = env_explosion::Explosion,
    }
}
