use xash3d_server::{
    ...
    entity::{MoveType, delegate_entity, BaseEntity, KeyValue, Solid, UseType},
    prelude::*,
...
define_export! {
    export_target_cdaudio as export if "target-cdaudio" {
        target_cdaudio = target_cdaudio::TargetCdAutio,
    }
}
