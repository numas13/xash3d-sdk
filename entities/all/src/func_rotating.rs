...
use xash3d_server::{
    ...
    entity::{
        delegate_entity, BaseEntity, DamageFlags, EntityVars, KeyValue, MoveType, ObjectCaps,
...
define_export! {
    export_func_rotating as export if "func-rotating" {
        func_rotating = func_rotating::Rotating,
    }
}
