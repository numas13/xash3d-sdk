use xash3d_server::{
    entity::{delegate_entity, BaseEntity, EdictFlags, Effects, MoveType, ObjectCaps, Solid},
    ffi::common::vec3_t,
    prelude::*,
...
define_export! {
    export_spark_shower as export if "spark-shower" {
        spark_shower = spark_shower::SparkShower,
    }
}
