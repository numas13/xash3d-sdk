...
pub trait PlayerMoveExt {
    ...
    fn info_value_for_key_raw(&self, physinfo: &CStr, key: &CStr) -> *const c_char;

    fn info_value_for_key<T: FromStr>(&self, physinfo: &CStr, key: &CStr) -> Option<T>;
