...
use shared::{
    ...
    raw::{cl_entity_s, wrect_s},
};
use utils::str::{AsPtr, ToEngineStr};

use crate::raw::{kbutton_t, KeyState};

pub use crate::efx::EfxApi;
pub use crate::event::EventApi;
pub use crate::studio::{studio, studio_set};
...
pub fn engine_set(funcs: raw::cl_enginefuncs_s) {
